      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row gap-0 mb-8">
          ...
          <div className="flex-1 space-y-4 px-6 md:pl-0 md:pr-10 py-4 md:py-0">
            ...
            <div className="flex gap-4 pt-2">
              <a href={footerData?.instagram || '#'} className="text-white/50 hover:text-white transition-colors">
              ...
              <a href={footerData?.twitter || '#'} className="text-white/50 hover:text-white transition-colors">
        ...
        <div className="pt-8 border-t border-white/15 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[10px] text-white/50">
            {footerData?.copyright || '© 2026 Woodora. Built for generations.'}
          </p>
