      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-4">
            <h3 className="font-serif text-xl font-bold text-brand-dark">{footerData?.logo ? <img src={getImageSrc(footerData.logo)} alt="Logo" className="h-8 object-contain" /> : 'Woodora'}</h3>
