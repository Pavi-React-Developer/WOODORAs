                ...
                <div key={order._id} className="bg-white rounded-[20px] shadow-sm border border-[#E9E9E9] overflow-hidden mb-4 sm:rounded-3xl sm:border-[#E6DFD4]">
                  ...
                  <div className="block sm:hidden p-4">
                    ...
                    <div className="flex gap-3">
                      <button onClick={() => onNavigate('/profile/order-history/details', order)} className="flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-lg border border-[#8B5E3C] text-[#8B5E3C] text-[13px] font-bold transition-colors hover:bg-[#F0EAE1]">
                        View Details
                      </button>
