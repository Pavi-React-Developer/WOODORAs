...
export default function GSTRulesPage() {
                    ...
                    <table className="w-full text-sm">
                        <thead className="sticky top-0 bg-[#F8F4EC] border-b border-[#E6DFD4]">
                            <tr>
                                ...
                                <th className="px-6 py-3.5 text-[11px] font-bold uppercase tracking-widest text-[#8B5E3C] whitespace-nowrap text-left">GST Name</th>
                                <th className="px-6 py-3.5 text-[11px] font-bold uppercase tracking-widest text-[#8B5E3C] whitespace-nowrap text-left">Percentage (%)</th>
                                <th className="px-6 py-3.5 text-[11px] font-bold uppercase tracking-widest text-[#8B5E3C] whitespace-nowrap text-left">Status</th>
                            ...
                            {loading ? (
                                ...
                                rules.map((rule, idx) => (
                                    <tr key={rule._id} className={`border-b border-[#F0EAE2] transition-colors hover:bg-[#FDF9F5] ${idx % 2 === 0 ? 'bg-white' : 'bg-[#FAFAFA]'}`}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap font-bold text-sm text-gray-800">{rule.name}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-600">{rule.percentage}%</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm">
