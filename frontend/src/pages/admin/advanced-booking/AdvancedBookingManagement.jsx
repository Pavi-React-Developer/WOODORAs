                  ...
                  <tr key={booking._id} className="transition-colors hover:bg-[#FDF9F5] bg-white group">
                    ...
                    <td className="px-4 py-5">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-bold text-[#141225]">{booking.customerName}</div>
                          <div className="text-xs text-gray-500">{booking.phoneNo}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-4 py-5">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-bold text-[#141225] text-sm">{booking.productName}</div>
                          <div className="text-xs text-gray-500">Attr: {Object.keys(booking.variants || {}).length}</div>
                        </div>
                      </div>
                    </td>
